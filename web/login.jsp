<%-- 
    Document   : login
    Created on : Jul 8, 2020, 2:54:44 PM
    Author     : Vinamra
--%>
        ...
        <table width="100%" border="0" cellspacing="1" cellpadding="1" align="center">
          ...
          <tr>
            <td colspan="2" nowrap><b><a href="javascript:enter()"><font face="Verdana, Arial, Helvetica, sans-serif" size="-1">Enter</font></a></b>
              <b><font face="Verdana, Arial, Helvetica, sans-serif" size="-1">chat room</font></b>
              <select name="chatrooms" onChange="info(this.options[selectedIndex].value);">
                <option value="none">Select a chat room</option>
                 <%
          ...
          <tr bgcolor="#999999">
            <td bgcolor="#AAAAAA">
              <table width="100%" border="0" cellspacing="1" cellpadding="2">
                <tr bgcolor="#FFFFFF">
                  <td nowrap><font size="-2" face="Verdana, Arial, Helvetica, sans-serif">Chat Room
